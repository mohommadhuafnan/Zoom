...
export default function VideoTile({ stream, name, muted = false, isLocal = false, videoOff = false }) {
  ...
  return (
    <div className="relative bg-zinc-800 rounded-xl overflow-hidden aspect-video min-h-[180px]">
      {!showPlaceholder ? (
        <video
          ref={videoRef}
          autoPlay
